    ...
    return (
        <main className="max-w-2xl mx-auto p-10 bg-white shadow-xl rounded-3xl mt-10">
            ...
            <form action={cadastrarPrato} className="flex flex-col gap-4">
                <input name="nome" placeholder="Nome do Prato" required className="p-3 border
rounded-xl" />
                ...
                <input name="imagem" type="url" placeholder="URL da imagem (Unsplash)" required
                    className="p-3 border rounded-xl" />
                ...
                <button type="submit" className="bg-orange-600 text-white p-4 rounded-xl font-bold
