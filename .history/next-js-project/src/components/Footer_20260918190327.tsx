...
export default function Footer(){
    ...
    return(
        ...
        <footer>
           <div className="flex flex-cols-3 items-center justify-center space-around bg-[#101828] p-15">
                <div>
                    <h2 className="font-bold text-orange-600 text-2xl mb-5 ">
                        Sabor & Arte
                    </h2>

                    <p className="w-110 mb-5 w-60 text-[#506982]">
                ...
                <div>
                    ...
                    <hr className="border-[#151E2E] h-1"/>
