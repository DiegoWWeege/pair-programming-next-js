...
export default async function PaginaCardapio({searchParams : URLSearchParams}){
                    ...
                    { produtos.map((prato : any) =>{
                        ...
                        <div className = "p-6 flex flex-col flex-grow">
                            <div className="flex justify-between items-start mb-2">
                                <Link href={`/cardapio/${prato.id}`} className="hover:opacity-95 transition-opacity"></Link>
